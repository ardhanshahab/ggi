...
-->
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li class="nav-item @if($activePage == 'penghitungan_gaji-management') active @endif">
                <a class="nav-link" href="{{route('penghitungan_gaji.index')}}">
                    <i class="nc-icon nc-chart-pie-35"></i>
                    <p>{{ __("Penghitungan Gaji") }}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse @if($activeButton =='masterdata') show @endif" id="masterdata">
                    <ul class="nav">
                        ...
                        <li class="nav-item @if($activePage == 'karyawan-management') active @endif">
