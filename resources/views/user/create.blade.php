@extends('layouts.app', ['activePage' => 'user-management', 'activeButton' => 'laravel', 'title' => 'Light Bootstrap Dashboard Laravel by Creative Tim & UPDIVISION', 'navName' => 'Create User'])
                            ...
                            <form method="post" action="{{ route('user.store') }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama" id="input-nama" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" placeholder="{{ __('nama') }}" value="{{ old('nama') }}" required autofocus>
